//! Diagram extension for mordant (core).
//!
//! Parses ```mermaid code blocks and renders them as Mermaid diagrams.
//! Pure-Rust engine; the PyO3 option wrappers live in mordant-py/src/diagram.rs.
...
use crate::parser::{self, AnyAstTransformer, AstTransformer, ParserOptions};
