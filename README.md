...
A fast CommonMark + GFM Markdown parser and renderer, available as a native **Rust library** ([`mordant` on crates.io](https://crates.io/crates/mordant)) and as **Python bindings** (`pip install mordant`).
